...
De $n_\text{inicial} = n_\text{final}$ e $c = n/V$
$$
...
## Operações com reação química

:::example

### Cálculo do volume de uma solução a diluir com reação química
...
#### Escreva a expressão para o balanço em $\ce{S}$.
