...
A mesma quantidade de gás seco é coletada sob e mesma temperatura (mesmos $n$ e $T$). Da lei dos gases ideais, $PV = nRT$
$$
...
**Calcule** volume do cilindro de ácido sulfídrico.

####  Elabore uma tabela de equilíbrio.

|            |   $\ce{H2S}$   | $\ce{O2}$ | $\ce{SO2}$ | $\ce{H2O}$ |
| :--------- | :------------: | :-------: | :--------: | :--------: |
| início     |   $\pu{1,3}$   |    $0$    |    $0$     |    $0$     |
| reação     |      $-x$      |   $+x$    |    $+x$    |    $+x$    |
| equilíbrio | $\pu{1,3} - x$ |    $x$    |    $x$     |    $x$     |
...
| :--------- | :--------: | :-----------------------: | :--------: |
| início     |    $V$     |       $\pu{22} - V$       |    $0$     |
| reação     |    $-V$    |     $-\dfrac{3}{2}V$      |    $+V$    |
| equilíbrio |    $0$     | $\pu{22} - \dfrac{5}{2}V$ |    $V$     |

####  Insira os valores da tabela na expressão do volume total.

De $V_\mathrm{total} = V_{\ce{H2S}} + V_{\ce{O2}} + V_{\ce{SO2}}$
$$
    V_\mathrm{total} = (\pu{22 L} - \dfrac{5}{2}V) + V = \pu{22 L} - \dfrac{3}{2}V
$$

####  Calcule o volume incial de ácido sulfídrico igualando o volume total a $\pu{10 L}$.

$$
    \pu{22 L} - \dfrac{3}{2}V = \pu{10 L}
$$
logo,
$$
    V = \boxed{ \pu{8 L} }
...
um gás é proporcional à raiz quadrada da temperatura (Equação 3b) e inversamente propor-
cional à raiz quadrada da massa molar (Equação 1b), segue-se que:
$$
    \text{velocidade média} 
