...
#### Balanceie o oxigênio. 

Neste caso, um coeficiente estequiométrico fracionário será necessário:
$$
...
#### Converta a massa de ferro em quantidade utilizando sua massa molar.

De $n = m/M$
$$
    n_{\ce{Fe}}
        = \dfrac{ \pu{7 kg} }{ \pu{56 g//mol} } = \pu{125 mol}
$$
...
#### Converta a quantidade de $\ce{Fe2O3}$ em massa utilizando sua massa molar.

De $m = nM$
$$
    m(\ce{Fe2O3}) 
        = \pu{62,5 mol} \times \pu{160 g//mol}
        = \boxed{ \pu{10 kg} }
$$
...
#### Converta a massa de octano dada em gramas em quantidade utilizando sua massa molar.

De $n = m/M$
$$
    n_{\ce{C8H18}}
        = \dfrac{ \pu{684 g} }{ \pu{114 g//mol} }
        = \pu{6 mol}
$$
...
#### Converta a quantidade de $\ce{CO2}$ em massa usando a massa molar.

De $m = nM$
$$
    m_{\ce{CO2}}
        = \pu{48 mol} \times \pu{44 g//mol}
        = \pu{2,11 kg}
$$
...
> O rendimento teórico de um produto é a quantidade máxima que pode ser esperada com base na estequiometria de uma equação química. O rendimento percentual é a percentagem do rendimento teórico que foi realmente atingida.
...
a. **Calcule** massa de etino pode ser obtida.
b. **Calcule** massa do reagente em excesso que permanece após o término da reação.
...
\begin{aligned}
    n_{\ce{CaC2}}
        &= \dfrac{ \pu{100 g} }{ \pu{64 g//mol} } = \pu{1,56 mol} \\
    n_{\ce{H2O}}
        &= \dfrac{ \pu{100 g} }{ \pu{18 g//mol} } = \pu{5,55 mol}
\end{aligned}
$$
...
#### Converta a quantidade de $\ce{C2H2}$ em massa usando a massa molar.

De $m = nM$
$$
    m_{\ce{C2H2}}
        = \pu{1,56 mol} \times \pu{26 g//mol} 
        = \boxed{ \pu{40,6 g} }
$$

#### O reagente em excesso é a $\ce{H2O}$. Calcule a massa de água remanescente ao final da reação.

Como $\ce{5,55 mol}\;\ce{H2O}$ foram fornecidos e $\ce{3,12 mol}\;\ce{H2O}$ foram consumidos, a quantidade de água que sobrou é $\pu{5,55 mol} - \pu{3,12 mol} = \pu{2,43 mol}$. Portanto, a massa do reagente em excesso ao final da reação é
$$
    m_{\ce{H2O}, \text{final}}
        = \pu{2,43 mol} \times \pu{18 g//mol}
        = \boxed{ \pu{43,8 g} }
$$
...
\begin{aligned}
    n_{\ce{NO2}}
        &= \dfrac{ \pu{267 kg} }{ \pu{46 g//mol} } = \pu{6 kmol} \\
    n_{\ce{H2O}}
        &= \dfrac{ \pu{72 kg} }{ \pu{18 g//mol} } = \pu{4 kmol}
\end{aligned}
$$
...
#### Converta a quantidade de $\ce{HNO3}$ em massa usando a massa molar.

De $m = nM$
$$
    m_{\ce{HNO3}}
        = \pu{4 kmol} \times \pu{77 g//mol}
        = \pu{308 kg}
$$
...
Uma das muitas aplicações das reações químicas conduzidas em laboratórios é a identificação e determinação de substâncias. Em especifico, na **análise gravimétrica**, que é utilizada no
monitoramento ambiental, a quantidade da substância presente é determinada com base na medida da massa de um produto formado em uma reação.
...
Na versão clássica da técnica os produtos da combustão são passados por um tubo contendo pentóxido de fósforo, $\ce{P4O10}$, que absorve toda a água e em seguida por um tudo contendo hidróxido de sódio, $\ce{NaOH}$, que absorve todo o dióxido de carbono conforma a reação
$$
...
$$
    n_{\ce{C}, \text{amostra}} = n_{\ce{CO2}, \text{produto}}
$$
...
$$
    n_{\ce{H}, \text{amostra}} = 2 \times n_{\ce{H2O}, \text{produto}}
$$
...
\begin{aligned}
    n_{\ce{C}} 
        &= n(\ce{CO2}) 
        = \dfrac{ \pu{3,1 g} }{ \pu{44 g//mol} } 
        = \pu{0,7 mol} \\
    m_{\ce{C}} 
        &= \pu{0,7 mol} \times \pu{12 g//mol} = \pu{8,4 g}
\end{aligned}
$$
...
\begin{aligned}
    n_{\ce{H}}
        &= 2 \times n(\ce{H2O}) 
        = 2 \times \dfrac{ \pu{1,9 g} }{ \pu{19 g//mol} } 
        = \pu{0,21 mol} \\
    m_{\ce{H}} 
        &= \pu{0,21 mol} \times \pu{1 g//mol} = \pu{0,21 g}
\end{aligned}
$$
...
\begin{aligned}
    ...
    n_{\ce{O}}
        &= \dfrac{ \pu{0,56 g} }{ \pu{16 g//mol} } = \pu{0,035 mol}
\end{aligned}
$$
...
$$
\begin{aligned}
    n_{\ce{C}} &: \dfrac{\pu{0,7 mol}}{\pu{0,035 mol}} = 2 \\
    n_{\ce{H}} &: \dfrac{\pu{0,21 mol}}{\pu{0,035 mol}} = 6 \\
    n_{\ce{O}} &: \dfrac{\pu{0,035 mol}}{\pu{0,035 mol}} = 1
\end{aligned}
$$
