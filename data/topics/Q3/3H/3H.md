...
$$
Logo, $c = 1$ e a reação é de primeira ordem em $\ce{Br^-}$.
...
$$
Logo, $c = 1$ e a reação é de primeira ordem em $\ce{H3O^+}$. A lei de velocidade é
$$
...
$$
    k = \dfrac{ \pu{5,5e-3 M.s-1} }{ (\pu{0,20 M}) \times (\pu{0,10 M}) \times (\pu{0,15 M})^2 } 
        = \boxed{ \pu{12 M-3.s-1} }
$$
