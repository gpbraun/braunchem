...
a. **Calcule** velocidade média de desaparecimento de $\ce{H2}$. 
b. **Calcule** velocidade média única.
:::
...
a. **Calcule** a ordem da reação para cada reagente.
...
$$
    \boxed{ v = k [\ce{BrO3^-}][\ce{Br^-}][\ce{H3O^+}]^2 }
$$
