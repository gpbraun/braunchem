...
:::focus
A velocidade média de uma reação é a variação da concentração de uma espécie dividida pelo tempo que leva para que a mudança ocorra. A velocidade média única é a velocidade média dividida pelos coeficientes estequiométricos das espécies monitoradas. Técnicas espectroscópicas são muito usadas para estudar as velocidades de reação, particularmente em reações rápidas.
:::
