...
:::info
### Unidades
A velocidade da reação tem unidades $\pu{mol.L-1.s-1}$.
:::
...
durante um certo tempo, é registrada como $\pu{1,15 mmol.L-1.h-1}$. 
...
:::example
### Determinação das ordens de reação e das leis de velocidade a partir de dados experimentais
...
| **#** | $[\ce{BrO3^-}]$ $/\pu{mM}$ | $[\ce{Br^-}]$ $/\pu{mM}$ | $[\ce{H3O^+}]$ $/\pu{mM}$ | $v_{\ce{BrO3^-}}$ $/(\pu{mM.s-1})$ |
| ----- | -------------------------: | -----------------------: | ------------------------: | ---------------------------------: |
| **1** |                $\pu{0,10}$ |              $\pu{0,10}$ |               $\pu{0,10}$ |                         $\pu{1,2}$ |
| **2** |                $\pu{0,20}$ |              $\pu{0,10}$ |               $\pu{0,10}$ |                         $\pu{2,4}$ |
| **3** |                $\pu{0,10}$ |              $\pu{0,30}$ |               $\pu{0,10}$ |                         $\pu{3,5}$ |
| **4** |                $\pu{0,20}$ |              $\pu{0,10}$ |               $\pu{0,15}$ |                         $\pu{5,5}$ |
...
$$
    v_{\ce{BrO3^-}} = k [\ce{BrO3^-}]^a[\ce{Br^-}]^b[\ce{H3O^+}]^c
$$

#### Ordem em $\ce{BrO3^-}$. Compare os experimentos 1 e 2.

$$
    \dfrac{v_1}{v_2} = \dfrac{22}{222} = \dfrac{ \pu{1,2} }{ \pu{2,4} }
$$
...
$$
    v_{\ce{BrO3^-}} = k [\ce{BrO3^-}][\ce{Br^-}][\ce{H3O^+}]^2
$$
...
As unidades da constante de velocidade dependem da ordem total da reação e garantem que $k \times (\text{concentração})^a$ tenha as mesmas unidades da velocidade, $\text{concentração}/\text{tempo}$. Assim, quando a concentração está expressa em mols por litro e a velocidade, em $\pu{mol.L-1.s-1}$, as unidades de $k$ são:

Table:  Unidades das constantes de velocidade

| Ordem total     | 1          | 2                  | 3                   |
| --------------- | ---------- | ------------------ | ------------------- |
| Unidades de $k$ | $\pu{s-1}$ | $\pu{L.mol-1.s-1}$ | $\pu{L2.mol-2.s-1}$ |

e assim sucessivamente. 

Para um gás ideal, $PV = nRT$ indica que $n/V = P/RT$, de modo que $n/V$, seja proporcional à pressão. Como
$n/V$ é concentração (em $\pu{mol.L-1}$), a concentração é proporcional à pressão e, portanto, esta pode ser usada como medida da concentração. Se as concentrações dos reagentes são expressas como pressões parciais em atmosferas e a velocidade em $\pu{atm.s-1}$, as unidades de $k$ são:
...
$$
    \int_{[\ce{A}]_0}^{[\ce{A}]_t} \dfrac{ \mathrm{d}[\ce{A}] }{ [\ce{A}] } 
        = -k \overbrace{ \int_0^t \mathrm{d} }^t t = - kt
$$
...
Para determinar a relação entre a velocidade de reação e a meia-vida de um reagente, faça $t = t_{1/2}$ e $[\ce{A}]_t = \frac{1}{2} [\ce{A}]_0$

$$
    \dfrac{1}{2} [\ce{A}]_0 = [\ce{A}] e^{ -k t_{1/2} }
$$
...
Note que a concentração inicial foi cancelada.

:::

A derivação mostrou que, para uma reação de primeira ordem,
...
$$
    -\dfrac{ \mathrm{d}[\ce{A}] }{ \mathrm{d}t } 
        = -k[\ce{A}]^2
$$
...
$$
    \int_{[\ce{A}]_0}^{[\ce{A}]_t} \dfrac{ \mathrm{d}[\ce{A}] }{ [\ce{A}]^2 }  
        = \dfrac{1}{[\ce{A}]_t} - \dfrac{1}{[\ce{A}]_0}
$$
...
A meia-vida de um reagente em uma reação de segunda ordem é obtida fazendo-se $t = t_{1/2}$ e na Eq. 4 e então resolvendo para t1/2. A expressão resultante,

## As leis de velocidade integradas de ordem superior

| **Ordem da reação**         |                                **0** |
| --------------------------- | -----------------------------------: |
| Lei de velocidade           |                      $v = k[\ce{A}]$ |
| Lei de velocidade integrada |       $[\ce{A}]= [\ce{A}]_0 e^{-kt}$ |
| Linearização                | $\ln [\ce{A}] = \ln [\ce{A}]_0 - kt$ |
| Inclinação da reta          |                                 $-k$ |
| Meia-vida                   |        $t_{1/2} = \dfrac{\ln(2)}{k}$ |