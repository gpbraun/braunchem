...
As observações de Geiger e Marsden espantaram a todos. Embora quase todas as partículas $\alpha$ passassem e sofressem eventualmente um desvio muito pequeno, cerca de 1 em cada
$\pu{20000}$ sofria um desvio superior a $\pu{90}\degree$, e algumas poucas partículas voltavam na direção da trajetória original. "Foi quase inacreditável", declarou Rutherford, "foi como se você disparasse uma bala de canhão de 15 polegadas contra um lenço de papel e ela rebatesse e o atingisse".
...
#### Use a relação entre frequência e comprimento de onda.
