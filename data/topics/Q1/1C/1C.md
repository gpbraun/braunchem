...
![Os nomes dos blocos da Tabela Periódica indicam a última subcamada ocupada de acordo com o princípio da construção. As cores dos blocos correspondem às cores usadas para representar os orbitais.](1C-5D.svg)
...
![Primeiras energias de ionização dos elementos do grupo principal, em quilojoules por mol. Em geral, os valores baixos são encontrados na parte inferior, à esquerda da tabela, e os valores altos, no topo, à direita.Raios iônicos (em picômetros) dos íons dos elementos do grupo principal. Observe que os cátions são, em geral, menores do que os átomos de origem, enquanto os ânions são maiores --- e, em alguns casos, muito maiores.](1C-4D.svg)
...
![Variação da afinidade eletrônica em quilojoules por mol dos elementos do grupo principal. Quando dois valores são fornecidos, o primeiro refere‑se à formação do íon com carga unitária, e o segundo, à energia adicional necessária para produzir um ânion com duas cargas. O sinal negativo do segundo valor indica que energia é necessária para adicionar um elétron a um ânion com carga unitária. A variação é menos sistemática do que a da energia de ionização, mas altos valores tendem a ser encontrados perto do flúor (exceto para os gases nobres).](1C-2D.svg)
