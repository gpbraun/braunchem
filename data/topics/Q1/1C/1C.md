...
$$
Em que $E_{\ce{X(g)}}$ é a energia do átomo $\ce{X}$ na fase gás e $E_{\ce{X^-(g)}}$ é a energia do ânion na msma fase. Por exemplo, a afinidade do cloro é a energia liberada no processo
$$
    \ce{ Cl(g) + e^-(g) -> Cl^-(g) } 
