...
$$
\begin{aligned}
    & \ce{H2O} && \ce{H2CO} && \ce{NO2^-} \\ 
    & 2 \times 1 + 6 = 8 \quad && 2 \times 1 + 4 + 6 = 12 \quad &&  5 + 2\times 6 + 1 = 18 \\
    & \text{(4 pares)} && \text{(6 pares)} && \text{(9 pares)} 
\end{aligned}
$$
...
Por exemplo, quando uma solução de bromo, marrom-avermelhada, é misturada com um alqueno como o 1-hexeno, a cor do bromo desaparece porque as moléculas de $\ce{Br2}$ atacam as ligações duplas:
$$
    \ce{  CH2=CHCH2CH2CH2CH3(l) + Br2(l) -> CH2BrCHBrCH2CH2CH2CH3(l) }
$$
