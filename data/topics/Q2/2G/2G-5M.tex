...
\schemestart
    ...
    \chemfig[fixed length=true]
        {
            {\color{red}H}-[1]\charge{90:2pt=\:, 40:4pt=$\scriptstyle +$}{O}(-[-4]H)-[-1]H
        }
...
\chemmove[shorten <=3pt, shorten >=3pt]
    {
        \draw[green, semithick, shorten <=8pt] (O0) ..controls+ (30:10mm) and+ (120:10mm).. (H1);
