...
$$
   \Delta G_\mathrm{r} = 2 G_{\mathrm{m}, \ce{NH3}} - (G_{\ce{N2}} + 3 G_{\ce{H2}})
$$
...
- $\Delta G^\circ$ é fixo para uma dada reação e temperatura e, por isso, não varia durante a reação.
- $\Delta G$ só depende da composição da mistura de reação; logo, varia – e pode até trocar de
...
\begin{aligned}
   \Delta H_\mathrm{r} 
      &= 3 \Delta H_{\mathrm{f}, \ce{CO2}} - 2 H_{\mathrm{f}, \ce{Fe2O3}} \\
      &= 3 \times (\pu{-394 kJ//mol}) -  2 \times (\pu{-824 kJ//mol})
\end{aligned}
$$
