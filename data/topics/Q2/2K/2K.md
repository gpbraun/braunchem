...
A diferença de potencial gerada por uma célula de Daniell na qual são usadas soluções $\pu{1,00 mol.L-1}$ em íons zinco e $\pu{0,01 mol.L-1}$ em íons cobre(II) é $\pu{+1,04 V}$.
