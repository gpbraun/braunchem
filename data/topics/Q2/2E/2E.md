...
| :----------------- | :------------------------: |
| Argônio            |       $\pu{7,9e-4}$        |
| Dióxido de carbono |       $\pu{1,5e-3}$        |
| Hélio              |       $\pu{3,7e-4}$        |
| Hidrogênio         |       $\pu{8,5e-4}$        |
| Neônio             |       $\pu{5,0e-4}$        |
| Nitrogênio         |       $\pu{7,0e-4}$        |
| Oxigênio           |       $\pu{1,3e-3}$        |
...
A concentração de oxigênio na água adequada para sustentar a vida aquática, deve ser superior a $\pu{0,13 mmol.L-1}$. Considere um lago sob atmosfera em $\pu{20 \degree C}$ e $\pu{1 atm}$.
...
\tag{3}
$$
A constante $k_\mathrm{b}$ é chamada de **constante do ponto de ebulição** do solvente. Ela é diferente para cada solvente e deve ser determinada experimentalmente  (Tabela 2).
...
$$
    \Delta T_\mathrm{b} 
        = (\pu{0,51 K.kg//mol}) \times (\pu{0,1 mol//kg}) 
        = \pu{0,05 K}
$$
...
\tag{4a}
$$
A constante $k_\mathrm{f}$ é chamada de constante do ponto de congelamento do solvente. Ela é diferente para cada solvente e deve ser determinada experimentalmente (Tabela 2).

:::displaytable

#### Constantes do ponto de ebulição e congelamento

|             | $T_\mathrm{fus}/\pu{\degree C}$ | $k_\mathrm{f}/\pu{K.kg//mol}$ | $T_\mathrm{eb}/\pu{\degree C}$ | $k_\mathrm{b}/\pu{K.kg//mol}$ |
| :---------- | ------------------------------: | ----------------------------: | -----------------------------: | ----------------------------: |
| Acetona     |                      $\pu{-95}$ |                   $\pu{2,40}$ |                      $\pu{56}$ |                   $\pu{1,71}$ |
| Benzeno     |                        $\pu{5}$ |                   $\pu{5,12}$ |                      $\pu{80}$ |                   $\pu{2,53}$ |
| Cânfora     |                      $\pu{180}$ |                  $\pu{39,70}$ |                     $\pu{204}$ |                   $\pu{5,61}$ |
| $\ce{CCl4}$ |                      $\pu{-23}$ |                  $\pu{29,80}$ |                      $\pu{76}$ |                   $\pu{4,95}$ |
| Cicloexano  |                        $\pu{6}$ |                  $\pu{21,10}$ |                      $\pu{81}$ |                   $\pu{2,79}$ |
| Naftaleno   |                       $\pu{80}$ |                   $\pu{6,94}$ |                     $\pu{217}$ |                   $\pu{5,80}$ |
| Fenol       |                       $\pu{43}$ |                   $\pu{7,27}$ |                     $\pu{182}$ |                   $\pu{3,04}$ |
...
$$
    \Delta T_\mathrm{f} 
        = (\pu{5,1 K.kg//mol}) \times (\pu{0,2 mol//kg}) 
        = \pu{1 K}
$$
...
$$
    T_\mathrm{f} 
        = \pu{5,5 \degree C} - \pu{1 \degree C} 
        = \boxed{ \pu{4,5 \degree C} }
$$

:::

O efeito do abaixamento do ponto de congelamento e aumento do ponto de ebulição pode ser visualizado no diagrama de fases.

![Diagrama de fases para uma substância antes e após a adição de um soluto. A linha tracejada mostra o efeito da adição do soluto, abaixando o ponto de congelamento e aumentando o ponto de ebulição.](2E-6P.svg)
...
$$
    \Delta T_\mathrm{f} 
        = (\pu{1,8 K.kg//mol}) \times (\pu{0,1 mol//kg}) \times 2 
        = \pu{0,36 K}
$$
...
$$
    T_\mathrm{f} 
        = \pu{0 \degree C} - \pu{0,36 \degree C} 
        = \boxed{ \pu{-0,36 \degree C} }
$$
...
$$
    n_{\ce{S_x}} 
        = (\pu{0,01 mol.kg-1}) \times (\pu{0,1 kg}) 
        = \pu{1e-3 mol}
$$
...
$$
    M_{\ce{S_x}} 
        = \dfrac{ \pu{0,26 g} }{ \pu{1e-3 mol} } 
        = \boxed{ \pu{260 g.mol-1} }
$$
...
$$
    x = \dfrac{ \pu{260 g//mol} }{ \pu{32 g//mol} } 
        = 8
$$
...
#### Use a equação van't Hoff para a pressão osmótica.
