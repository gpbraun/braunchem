...
Você chegou agora ao ponto mais importante deste tópico. No equilíbrio, as atividades (pressões parciais ou molaridades) de todas as substâncias que participam da reação estão em seu valor de equilíbrio. Neste ponto, a expressão de $Q$ (em que as atividades estão em seu valor de equilíbrio) torna-se igual à constante de equilíbrio, $K$, da reação. No equilíbrio, $Q = K$. A termodinâmica explicou a estranha forma de $K$: ela é uma consequência direta da Equação 5, que mostra como a energia livre de Gibbs de uma substância depende de sua composição e que $K$ é simplesmente o valor de $Q$ quando todas as espécies estão em seus valores de equilíbrio.
