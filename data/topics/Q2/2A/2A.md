...
- $C_{P, \ce{N2}} = \pu{29 J.K-1.mol-1}$
- $C_{P, \ce{H2}} = \pu{28 J.K-1.mol-1}$
- $C_{P, \ce{NH3}} = \pu{35 J.K-1.mol-1}$
...
\begin{aligned}
    \Delta H_1^\circ
        ...
        &= \Big\{ (\pu{29}) + 3(\pu{28}) \Big\}\,\pu{J//mol.K} \times (\pu{298 K} - \pu{698 K}) \\
        &= \pu{-24 kJ.mol-1}
\end{aligned}
$$
...
\begin{aligned}
    \Delta H_2^\circ
        ...
        &= 2(\pu{35 J//mol.K}) \times (\pu{698 K} - \pu{298 K}) \\
        &= \pu{14 kJ.mol-1}
\end{aligned}
$$
