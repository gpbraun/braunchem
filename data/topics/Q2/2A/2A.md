...
Como nenhum trabalho é realizado, $\Delta U = q$. De $q = -q_\mathrm{cal} = -C_\mathrm{cal} \Delta T$, no segundo experimento:
$$
    \Delta U = q 
        = - (\pu{0,5 kJ.K-1}) \times \pu{1,2 \degree C} 
        = \boxed{ \pu{-0,6 kJ} }
$$
...
E, portanto,
$$
    \boxed{ \Delta H = \Delta U - \Delta n_\text{gás} RT }
$$
