...
import braunchem.legacy.convert as convert
...
class Problem:
    ...
    def tex_choices(self):
        ...
        tex_choices = [
            latex.cmd("everymath", latex.cmd("displaystyle")) + convert.md2tex(c)
    ...
    def from_file(cls, path):
        ...
        if prop_list:
            ...
            kwargs["choices"], kwargs["answer"], kwargs["obj"] = autoprops(true_props)
...
class ProblemSet:
    ...
    def tex_statements(
        ...
        statements = "\n".join(
            [p.astex(points, print_solutions, print_data) for p in self.problems]
        )
