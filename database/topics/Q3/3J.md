...
> **Importante** Oxidação é a perda de elétrons, redução é o ganho de elétrons. A reação redox é a combinação de oxidação e redução.
...
> **Nota** É muito importante entender que uma meia-reação de oxidação é meramente uma maneira conceitual de representar uma oxidação: os elétrons nunca estão realmente livres. Seu estado não é dado porque eles estão em trânsito e não têm um estado físico definido.
...
> **Atenção** Ao balancear semi-reações de ácidos oxidantes, note que os ácidos também são a fonte de $\ce{H+}$.
