...
#### Converta cada massa em uma quantidade de átomos em mols usando a massa molar do elemento.
$$
\begin{aligned}
...
#### Divida cada quantidade pela menor quantidade ($\pu{3,41 mol}$).
$$
\begin{aligned}
...
#### Rearranje $d = PM/RT$ para $M = dRT/P$ e substitua os dados, selecionando um valor de $R$ expresso em torr e litros:
$$
\begin{aligned}
